...
public class DecksDatabase {
	//Estrutura jogadores: (String nomeCarta, int custoMana, int ataque, int defesa, String passiva)
	//Estrutura táticas: (String nomeCarta, int custoMana, String efeito)
	//Estrutura jogadas: (String nomeCarta, int custoMana, String efeito)
	public static ArrayList<Carta> criarDeckBulls() {
		ArrayList<Carta> deck1 = new ArrayList<>();
		deck1.add(new Jogadores("Michael Jordan", 6, 16, 12, "O GOAT: Ganha +2 de ataque para cada inimigo em campo"));
		...
		deck1.add(new Jogadores("Steve Kerr", 4, 9, 6, "Clutch: Se o jogador tiver menos que 10 de vida, ganha +5 de ataque"));
		...
		deck1.add(new Taticas("Clutch time", 2, "Aumenta em o ataque do time aliado em +1; se o player tiver menos que 10 de vida, aumenta em +3"));
	...
	public static ArrayList<Carta> criarDeckHeat() {
		...
		deck1.add(new Jogadas("Camisa aposentada", 3, "Escolha uma carta para voltar do cemitério à mão"));
		deck1.add(new Jogadas("Dia do draft", 3, "Compre 2 cartas"));
		deck1.add(new Taticas("Motivação com Pat Riley", 4, "Todo o time aliado se concentra, ganhando +5 de ataque por dois turnos"));
		deck1.add(new Taticas("Provocação", 2, "Reduz em -2 a defesa do time inimigo"));
		deck1.add(new Taticas("Clutch time", 2, "Aumenta em o ataque do time aliado em +1; se o player tiver menos que 10 de vida, aumenta em +3"));
		deck1.add(new Taticas("Substituição tática", 2, "Troque uma carta em campo por uma da mão; ela recebe +1 de ataque"));
		deck1.add(new Taticas("Estrela do time", 2, "Um jogador recebe +1 de ataque e defesa para cada carta aliada em campo; todos os aliados perdem -1 de ataque e defesa"));
