...
public class Gameplay {
	...
	public void Partida() {
		...
		player1.puxarMao(player1.getDeck());
		player2.puxarMao(player2.getDeck());
		System.out.println("Ambos os jogadores começam com 30 pontos de vida e 1 ponto de mana.");
		System.out.println("O jogo acaba quando um dos jogadores ficam sem vida ou sem cartas disponíveis para compra.");
	}
